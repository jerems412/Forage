...
<body style="background-image:url('public/Admin/img/intro.svg');background-color:#3c373e;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-nav-header">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="font-weight:bold;">Facture List </a>
                    </li>
    ...
    <div class="contente">
        ...
        <div class="table-responsive">
            <h2 class="mb-5">Factures list</h2>
            <table class="table table-striped custom-table">
                ...
                <tbody>
                    <?php
                    $cpt = 0;
                    foreach ($_SESSION['factures'] as $value) {
                        $cpt++;
                        echo '<tr scope="row">';
                        echo '<td><a href="#">' . $cpt . '</a></td>';
                        echo "<td>" . $value['dateF'] . "</td>";
                        echo "<td>" . $value['prixUnitaireF'] . "</td>";
                        echo "<td>" . $value['consommationCL'] . "</td>";
                        echo "<td>".$value['consommationC']."</td>";
                        echo "<td>".$value['nameClient']."</td>";
                        echo '<td><a onclick="regler('.$value['id'].')" style="cursor:pointer;background:green;padding:10px;color: whitesmoke;font-weight:bold;">paid bill</a></td>';
                        echo "</tr>";
                    }
