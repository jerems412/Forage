        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-nav-header">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="font-weight:bold;">List Customer</a>
                    </li>
                    <li class="nav-item">
            ...
            <table class="table table-striped custom-table">
                ...
                <tbody>
                    ...
                    foreach ($_SESSION['clients'] as $value) {
                        ...
                        echo "<td>" . $value['adresseClient'] . "</td>";
                        echo "<td>" . $value['telephoneClient'] . "</td>";
                        echo "<td>" . $value['nameVillage'] . "</td>";
                        echo "</tr>";
                    }
